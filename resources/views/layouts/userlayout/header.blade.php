<header>
		...
		<div class="middle-w3ls-nav py-2">
			<div class="container">
				<div class="row">
					<a class="logo font-italic font-weight-bold col-lg-4 text-lg-left text-center" href="{{url('index')}}">Edulearn</a>
					<div class="col-lg-8 right-info-agiles mt-lg-0 mt-sm-3 mt-1">
						<div class="row">
							...
							<div class="col-sm-4 col-6 top-login-butt text-right mt-sm-2">
								<a href="{{url('userlogin')}}" class="button-head-mow3 text-white">Login</a>
							</div>
						</div>
					</div>
				</div>
