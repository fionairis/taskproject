...
<!-- Mainly scripts -->
<script src="{{asset('adminasset/js/jquery.metisMenu.js') }}"></script>
<script src="{{asset('adminasset/js/jquery.slimscroll.min.js') }}"></script>
<!-- Custom and plugin javascript -->
<link href="{{asset('adminasset/css/custom.css') }}" rel="stylesheet">
<script src="{{asset('adminasset/js/custom.js') }}"></script>
<script src="{{asset('adminasset/js/screenfull.js') }}"></script>
		<script>
		$(function () {
...
<!--skycons-icons-->
<script src="{{asset('adminasset/js/skycons.js') }}"></script>
<!--//skycons-icons-->
</head>
<body>
<div id="wrapper">
