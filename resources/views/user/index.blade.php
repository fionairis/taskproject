		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row news-grids-w3l pt-md-4">
				<div class="col-md-4 news-grid">
					<a href="blog.html">
						<img src="{{asset('userasset/images/n1.jpg')}}" class="img-fluid" alt="" />
					</a>
					<div class="news-text">
				...
				<div class="col-md-4 news-grid my-md-0 my-sm-5 my-4">
					<a href="blog.html">
						<img src="{{asset('userasset/images/n.jpg')}}" class="img-fluid" alt="" />
					</a>
					<div class="news-text">
				...
				<div class="col-md-4 news-grid">
					<a href="blog.html">
						<img src="{{asset('userasset/images/n3.jpg')}}" class="img-fluid" alt="" />
					</a>
					<div class="news-text">
